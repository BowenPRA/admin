...
export const TEACHER_SCHEDULE = [
  ...
  { email: 'caleb@pra.edu.vn', name: 'Caleb', title: 'Mr.', role: 'teacher', subjects: [...years('english', ['Year 2', 'Year 3']), ...years('math', ['Year 2', 'Year 3']), ...years('science', ['Year 2', 'Year 3']), ...years('technology', ['Year 2', 'Year 3', 'Year 4', 'Year 5'])], homeroom_groups: ['Year 2', 'Year 3'] },
